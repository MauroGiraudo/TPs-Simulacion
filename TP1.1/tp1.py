...
for i in range(num_corridas):
  ...
  valores.extend(valores_corrida)
  ...
  axs[0, 0].plot(x1, frec_relativas, color='purple', label=f"Frecuencia Relativa de {valor_elegido} respecto a {num_tiradas}")
  ...
  axs[0, 1].plot(x1, medias, color='black', label=f"Media respecto a {num_tiradas}")
  ...
  axs[1, 0].plot(x1, varianzas, color='gray', label=f"Varianza de {valor_elegido} respecto a {num_tiradas}")
  ...
  axs[1, 1].plot(x1, desvios_estandar, color='brown', label=f"Desvio Estandar de {valor_elegido} respecto a {num_tiradas}")
