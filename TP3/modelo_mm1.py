...
def llegada():
    ...
    if estado_servidor == 'OCUPADO':
        ...
        # Además, se incrementa el número de clientes en la cola
        num_en_cola += 1
...
if(len(sys.argv) != 9 or sys.argv[1] != '-a' or sys.argv[3] != '-s' or sys.argv[5] != '-c' or sys.argv[7] != '-e'):
  print("Uso: python modelo_mm1.py -a <tiempo medio entre arribos> -s <tiempo medio de servicio> -c <cantidad de clientes a simular> -e <número de ejecuciones/corridas>")
  sys.exit(1)

# Lista de tamaños de cola que queremos evaluar
limites_cola = [0, 2, 5, 10, 50]
cant_corridas = int(sys.argv[8])
limite_cola = 10
x1 = list(range(1, cant_corridas + 1))
...
for corrida in range(1, cant_corridas+1):
    ...
    denegados = num_llegadas_denegadas 
...
# Clientes en sistema
plt.subplot(2, 3, 1)
plt.plot(x1, clientes_en_sistema_prom, marker='o')
...
# Clientes en cola
plt.subplot(2, 3, 2)
plt.plot(x1, clientes_en_cola_prom, marker='o', color='orange')
...
# Tiempo en sistema
plt.subplot(2, 3, 3)
plt.plot(x1, tiempos_en_sistema_prom, marker='o', color='green')
...
# Tiempo en cola
plt.subplot(2, 3, 4)
plt.plot(x1, tiempos_en_cola_prom, marker='o', color='red')
...
plt.subplot(2, 3, 5)
plt.plot(x1, utilizaciones, marker='o', color='purple')
...
plt.subplot(2, 3, 6)
plt.plot(x1, prob_denegacion, marker='o', color='brown')
